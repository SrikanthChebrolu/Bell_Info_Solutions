                    ...
                    <div class="item active">
                	    <div class="col-md-4 col-sm-6">
        				    <div class="block-text rel zmin">
						        <a title="" href="https://www.facebook.com/bala7056">Bala Krishna Ponnam</a>
							    <div class="mark">My rating:<span class="rating-input"><span data-value="5" class="glyphicon glyphicon-star"></span><span data-value="1" class="glyphicon glyphicon-star"></span><span data-value="2" class="glyphicon glyphicon-star"></span><span data-value="3" class="glyphicon glyphicon-star"></span><span data-value="4" class="glyphicon glyphicon-star-empty"></span><span data-value="5" class="glyphicon glyphicon-star-empty"></span>  </span></div>
							...
							<div class="person-text rel">
								...
								<img src="/BellInfo/resources/images/11.jpg" height="100" width="100"/>
								<a title="" href="#">Anna</a>
            			...
            			<div class="col-md-4 col-sm-6 hidden-xs">
						    <div class="block-text rel zmin">
						        <a title="" href="https://www.facebook.com/saras498">Sirisha Sajja</a>
							...
							<div class="person-text rel">
								...
								<img src="/BellInfo/resources/images/22.jpg" height="100" width="100"/>
						...
						<div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
							<div class="block-text rel zmin">
								<a title="" href="#">Pravani keerthi</a>
							...
							<div class="person-text rel">
								...
								<img src="/BellInfo/resources/images/33.jpg" height="100" width="70"/>
